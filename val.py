...
class CheckpointManager(object):
    ...
    def restore_lastest_checkpoint(self):
        if os.path.exists(os.path.join(self.logdir, 'last.pth')):
            ...
            print("Restored the last checkpoint.")
...
def main():
    ...
    writers['val'].add_scalar('Loss', metrics['loss'].result, ckpt.epoch)
    writers['val'].add_scalar('mAP@[0.5]', mAP50, ckpt.epoch)
    writers['val'].add_scalar('mAP@[0.5:0.95]', mAP, ckpt.epoch)
